...
<div class="center-img">
  ...
  alt="Fig. 1. Setting up local variables">
...
<div class="center-img">
  ...
  alt="Fig. 2. Assigning the local variable PickedBookingStartDate to the
  Input’s variable property">
  <figcaption class="figcaption">
    Fig. 2. Assigning the local variable PickedBookingStartDate to the Input’s
    variable property
  </figcaption>
</div>
<br>
...
<div class="center-img">
  ...
  alt="Fig. 3. Adding an action to the GetBookingById’s On After Fetch event">
  <figcaption class="figcaption">
    Fig. 3. Adding an action to the GetBookingById’s On After Fetch event
  </figcaption>
</div>
<br>
...
<div class="center-img">
  ...
  alt="Fig. 4. Getting any existing DB values with On After Fetch action">
  <figcaption class="figcaption">
    Fig. 4. Getting any existing DB values with On After Fetch action
  </figcaption>
</div>
<br>
...
<div class="center-img">
  ...
  alt="Fig. 5. Setting the Date Picker’s date format">
  <figcaption class="figcaption">
    Fig. 5. Setting the Date Picker’s date format
  </figcaption>
</div>
<br>
...
<div class="center-img">
  ...
  alt="Fig. 6. Setting the Date Picker’s OnSelect handlers">
  <figcaption class="figcaption">
    Fig. 6. Setting the Date Picker’s OnSelect handlers
  </figcaption>
</div>
<br>
...
<div class="center-img">
  ...
  alt="Fig. 7. Saving the Date Picker’s dates">
  <figcaption class="figcaption">
    Fig. 7. Saving the Date Picker’s dates
  </figcaption>
</div>
<br>
...
Check out [Part 2](https://twikah.github.io/work/2021/01/21/outsystems-datepicker-pt2.html)
of this guide to see how I tackled points 2 and 3 from the list!
